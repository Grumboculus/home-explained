  ...
  return (
    <div className="hover:cursor-pointer bg-white/10 rounded-lg overflow-hidden shadow-md transform transition-transform duration-300 hover:scale-105 hover:ring-2 hover:ring-gray-700">
      ...
      <div className="bg-gradient-to-br from-[#232323] to-[#00000] bg-[#0c0c12] text-white p-3">
        ...
        <p className="text-sm">{time}HRS🕝</p>
      </div>
    </div>
  );
};
  ...
  return (
    <div className="hover:cursor-pointer bg-white/10 rounded-lg overflow-hidden shadow-md transform transition-transform duration-300 hover:scale-105 hover:ring-2 hover:ring-gray-700">
      ...
      <div className="bg-gradient-to-br from-[#232323] to-[#00000] bg-[#0c0c12] text-white p-3">
        ...
        <p className="text-xs">{stime}HRS🕝</p>
      </div>
    </div>
  );
};
  ...
  return (
    <div className="hover:cursor-pointer bg-white/10 rounded-lg overflow-hidden shadow-md transform transition-transform duration-300 hover:scale-105 hover:ring-2 hover:ring-gray-700">
      ...
      <div className="bg-gradient-to-br from-[#232323] to-[#00000] bg-[#0c0c12] text-white p-3">
        ...
        <p className="text-xs">{VItime}HRS🕝</p>
      </div>
    </div>
  );
};

const CreatorCard = ({ CRtitle, CRavatar, CRprofileLink }) => {
  return (
    <div className="hover:cursor-pointer bg-white/10 rounded-lg overflow-hidden shadow-md transform transition-transform duration-300 hover:scale-105 hover:ring-2 hover:ring-gray-700">
      <div>
        <Avatar 
    ...
    <div className="bg-gradient-to-br from-[#232323] to-[#00000] min-h-screen bg-[#0c0c12] text-white">
      ...
      <div className="flex flex-col lg:flex-row h-auto min-h-[calc(100vh-64px)] px-6 gap-6 mt-4">
        ...
        <div className="w-full lg:w-1/2 flex flex-col gap-4">
          ...
          <div className="flex-[1] bg-black/30 rounded-lg p-4 backdrop-blur-md">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 mt-4">
              {/* Cards */}
              <CreatorCard CRtitle="Creator 1" CRavatar="/PlaceholderIMG.png" CRprofileLink="#" />
              <CreatorCard CRtitle="Creator 2" CRavatar="/PlaceholderIMG.png" CRprofileLink="#" />
              <CreatorCard CRtitle="Creator 3" CRavatar="/PlaceholderIMG.png" CRprofileLink="#" />
            </div>
          </div>
        ...
        <div>
          ...
          {/* Newest Section */}
          <div className="mb-8">
            <h3 className="text-2xl font-semibold mb-4">Newest</h3>
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
              {/* Cards */}
          ...
          <div className="mb-8 justify-between">
            <div className="flex justify-between">
              <button className="px-4 py-2 rounded-md bg-white/10 hover:bg-white/20 transition">View All 👁️</button>
              <button className="px-4 py-2 rounded-md bg-white/10 hover:bg-white/20 transition">Random 🎲</button>
              <button className="px-4 py-2 rounded-md bg-white/10 hover:bg-white/20 transition">Create Journey ✍️</button>
            </div>
          </div>
        </div>
        </div>
