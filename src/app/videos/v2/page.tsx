        ...
        <div className="flex-1 flex justify-center items-start p-4 mx-4 my-4">
          <div className="bg-black/20 backdrop-blur-md shadow-lg rounded-2xl w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col gap-8">
              ...
              <div className="w-full bg-black/30 p-4 rounded-2xl shadow-md">
                ...
                <iframe width="560" height="315" src="https://www.youtube-nocookie.com/embed/qkFYqY3vr84?si=fF0lL2WNw81FMnei" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen></iframe>
                  ...
                  <div className="bg-black/30 backdrop-blur-md shadow-lg my-4 mx-4 rounded-2xl p-4 flex justify-center border border-gray-600">
                    <DataList.Root size="2" >
                      <DataList.Item>
                        ...
                        <DataList.Value className="text-white">easy, actually</DataList.Value>
                      </DataList.Item>
                    ...
                    <DataList.Item>
                      ...
                      <DataList.Item>
                        ...
                        <DataList.Value>
                          <a
                           href="https://www.youtube.com/watch?v=qkFYqY3vr84&t=152s"
                      ...
                      <DataList.Item>
                        ...
                        <DataList.Value className="text-white">All credit goes to easy, actually for his video.</DataList.Value>
                      </DataList.Item>
                    </DataList.Root>
                  </div>
                </div>  
